...
Generates realistic hourly or half-hourly data centre load profiles and recoverable waste heat profiles that can be directly plugged into energy system models, grid simulators, and local area energy planning frameworks without requiring access to proprietary operational data.
